...
<spring:url value="/Setup/AddProjectRequest" var="AddProject" htmlEscape="true" />
<a href="${AddProject}" class="btn btn-primary">Add Projects</a>
<spring:url value="/Setup/departments" var="departments" htmlEscape="true" />
